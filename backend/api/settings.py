...
AUTH_USER_MODEL = 'deals.CustomUser'
...
REST_FRAMEWORK = {
    # SessionAuth and JWTAuth as session auth will still be used for admin login.
...
CORS_ALLOWED_ORIGINS = os.environ.get("ALLOWED_CORS_HEADERS").split(" ")